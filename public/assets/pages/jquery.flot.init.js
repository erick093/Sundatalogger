...
! function($) {
	...
	FlotChart.prototype.init = function() {
		...
		var colors = ['#458bc4', '#4fc55b', "#3db9dc", "#ebeff2"];
		this.createPieGraph("#pie-chart #pie-chart-container", pielabels, datas, colors);

		//real time data representation


		var plot = this.createRealTimeGraph('#flootRealTime', chartData, ['#23b195']);
		plot.draw();
		var $this = this;
		...
		var donutcolors = ['#458bc4', '#4fc55b', "#3db9dc", "#ebeff2"];
		...
		this.createStackBarGraph("#ordered-bars-chart", stack_ticks, ['#458bc4', '#3db9dc', "#ebeff2"], ds);
